...
1. ## Instalación Dual-Boot
   ...
   - **Espacio en Disco**: Asegúrate de tener espacio libre en el disco. Podés usar herramientas como _GParted_ para redimensionar particiones si es necesario.
   2. **Crear una Partición para Linux:**
    - Usá una herramienta de particionamiento para hacer una nueva partición para Linux. Asegúrate de dejar espacio suficiente para la instalación.
...
2. ## Instalación en una Máquina Virtual
    ...
    ### a. Usando VirtualBox:
      1. **Descargar e Instalar VirtualBox**:
          - Bájate VirtualBox desde su sitio oficial e instalalo en tu máquina.
      2. **Crear una Nueva Máquina Virtual:**
      	 - Abrí VirtualBox y crea una nueva máquina virtual. Asigná memoria (RAM) y espacio en disco según las recomendaciones de la distribución de Linux que quieras instalar.
      ...
      5. **Configuración Posterior:**
           - Una vez instalado, podés ajustar la configuración de la máquina virtual según lo necesités.

    ### b. Usando VMware:
      1. **Descargar e Instalar VMware Workstation Player:**
          - Bájate VMware Workstation Player desde su sitio oficial e instalalo en tu PC.
      2. **Crear una Nueva Máquina Virtual:**
      	 - Abrí VMware y crea una nueva máquina virtual, asignando recursos como memoria y espacio en disco.
      3. **Montar la Imagen ISO:**
...
####  Uso Básico de Docker:
   1. **Instalar Docker:**
         - Bájate e instalá Docker Desktop desde el sitio oficial para tu sistema operativo.
...
.
   ...
   4. **Trabajar dentro del Contenedor:**
         - Podés ejecutar comandos dentro del contenedor y configurar el entorno según lo necesités.
